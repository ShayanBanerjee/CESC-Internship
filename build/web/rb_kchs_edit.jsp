...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          <title>Complaint Edit Module</title>
...
function disableSingleQuote() {//------roshni----------------
    ...
    if(addto==''){
        alert("Please specify Addressed To")
         return false
    }
    if(cno==''){
    ...
    if(nm1=='' || nm1.replace(/^\s*|\s*$/g,'')=='' || nm1==' '  ){ //|| nm2=='' || nm2.replace(/^\s*|\s*$/g,'')=='' || nm2==' ' ){
        alert("Please enter valid name and address")
         return false
               ...
               var url="rb_kchs_edit_save.jsp?napsid="+document.getElementById("napsid").value;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#dceaef', endColorstr='#d8ffdd',GradientType=0 ); /* IE6-9 */">
 ...
 <input type="hidden" name="napsid" id="napsid"  />
    ...
    <input type="hidden" name="ofcd" id="ofcd" value="<%= soffcd%>" />
        <span class="style3"> <font size="4" color="0D599F">COMPLAINT EDIT MODULE</font>
                                             </span>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#febbbb', endColorstr='#ffc4f3',GradientType=1 ); /* IE6-9 */">
                    ...
                    <td   colspan="4" align="center"><b>
                       &nbsp;&nbsp;&nbsp;&nbsp; CN - <input type="text" id="df" maxlength='8' size=5 readonly name="df" value="<%=soffcd%>"  /> -
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#d2ff52', endColorstr='#91e842',GradientType=0 ); /* IE6-9 */">
                    ...
                    <td colspan="2" >
                        <input type="text" id="consno" disabled name="consno" onkeypress="onlydigit();" onchange="chkCons();" value="" size="15" maxlength="11" />
                    </td>
                    <th ALIGN="RIGHT" ><span class="style1"> &nbsp;NAPS Request ID.</span> &nbsp;</th>
                    <td colspan="2">
                        <input type="text" id="mrdst" size=7  name="mrdst" disabled value="<%=soffcd%>" onkeypress="onlydigit();"  />
                    ...
                    <td colspan="2"><input type="text" id="rcvddt" disabled maxlength='10' size=10 readonly name="rcvddt" value="<%= sysdt%>" onclick="javascript:NewCssCal('rcvddt','ddMMYYYY');"  /></td>
                    <th ALIGN="RIGHT"><span class="style1"> &nbsp;Entered On </span>&nbsp;</th>
                    <td colspan="2"><input type="text" id="entrdt" disabled maxlength='10' size=10 readonly name="entrdt" value="<%= sysdt%>"/></td>
                </tr>
                <tr>
                    <th ALIGN="RIGHT" width="15%" ><span class="style1"> &nbsp;Addressed To</span> &nbsp;</th>
                    <td width="15%" colspan="2"><select id="addto"  name="addto">
                            <option value=""></option>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <input type="text" id="nm_cmplnt" maxlength='50' size=50 name="nm_cmplnt" value="" style="text-transform: uppercase" onkeypress="disableSingleQuote()" />
                ...
                <tr>
                    <td align="center" colspan="6">
                        <input type="button"  id="btn_sub" name="btn_sub" value="Save" onclick="sv_Entry();" class="css_btn_class"/>&nbsp;&nbsp;
                        <input type="button"  id="btn_rest" name="btn_rest" value="Reset"  onclick="window.location.reload();"  class="css_btn_class"/>&nbsp;&nbsp;
                        </td>
                </tr>
